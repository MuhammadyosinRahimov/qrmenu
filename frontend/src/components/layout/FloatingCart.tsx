...
export function FloatingCart() {
  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 z-50 flex justify-center animate-in slide-in-from-bottom-4 duration-300 px-4">
      ...
      >
        <div className="w-full bg-gradient-to-r from-[#f7df00] to-[#f7df00] text-white rounded-full px-5 py-3 shadow-lg shadow-orange-200 flex items-center justify-between hover:shadow-xl hover:scale-[1.02] transition-all duration-200">
