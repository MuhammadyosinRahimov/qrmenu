        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedAddons = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@qrmenu.com", null, "Администратор", "$2a$11$j3T89IyjcY6md8XI.cnht.ZzVOZX5tRkTM4n3rJ66szeImQx98Iu." });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuCategories_MenuId_CategoryId",
                table: "MenuCategories",
