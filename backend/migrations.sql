...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    ALTER TABLE "TableSessions" ADD "ServiceFeePercent" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    ALTER TABLE "TableSessions" ADD "SessionServiceFee" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    ALTER TABLE "TableSessions" ADD "SessionSubtotal" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    ALTER TABLE "TableSessions" ADD "SessionTotal" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    ALTER TABLE "Restaurants" ADD "ServiceFeePercent" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "Admins" SET "PasswordHash" = '$2a$11$hnmBVcCef0Hj6mjHv454Gubl0BDoH0A0qG1XUaXIHOlT3s85g5FyW'
    WHERE "Id" = '11111111-1111-1111-1111-111111111111';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:08:26.836172Z'
    WHERE "Id" = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:08:26.836178Z'
    WHERE "Id" = 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:08:26.836179Z'
    WHERE "Id" = 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:08:26.836309Z'
    WHERE "Id" = '11111111-1111-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:08:26.836312Z'
    WHERE "Id" = '11111111-2222-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:08:26.83631Z'
    WHERE "Id" = '22222222-1111-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "RestaurantAdmins" SET "PasswordHash" = '$2a$11$ks4QOTYsL0waXruEgn3Ode1Fpt30xNONMrR6oXvkIMLVE.OlANp.u'
    WHERE "Id" = '66666666-6666-6666-6666-666666666666';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    UPDATE "Restaurants" SET "ServiceFeePercent" = 10.0
    WHERE "Id" = '22222222-2222-2222-2222-222222222222';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225100827_AddSessionServiceFee') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260225100827_AddSessionServiceFee', '7.0.20');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    ALTER TABLE "Orders" ADD "CompletedAt" timestamp with time zone NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "Admins" SET "PasswordHash" = '$2a$11$GtCL7GIw7eHZQBsQu3fptemvBPSBY.Lroqj/rn9aqKpoBGobSK.4y'
    WHERE "Id" = '11111111-1111-1111-1111-111111111111';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:46:53.610513Z'
    WHERE "Id" = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:46:53.610517Z'
    WHERE "Id" = 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:46:53.610597Z'
    WHERE "Id" = '11111111-1111-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-25 10:46:53.610598Z'
    WHERE "Id" = '11111111-2222-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "Orders" SET "CompletedAt" = NULL
    WHERE "Id" = '11111111-5555-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    UPDATE "RestaurantAdmins" SET "PasswordHash" = '$2a$11$n0rsVm7slX5sK6/EBCyrUeH80LXitR443l3TyXKocxLPyvNZvCFT.'
    WHERE "Id" = '66666666-6666-6666-6666-666666666666';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260225104654_AddCompletedAt') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260225104654_AddCompletedAt', '7.0.20');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Restaurants" ADD "DeliveryEnabled" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Restaurants" ADD "DeliveryFee" numeric(10,2) NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Restaurants" ADD "TakeawayEnabled" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD "CustomerName" character varying(100) NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD "CustomerPhone" character varying(20) NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD "DeliveryAddress" character varying(500) NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD "DeliveryFee" numeric(10,2) NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD "OrderType" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD "RestaurantId" uuid NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Admins" SET "PasswordHash" = '$2a$11$rkrv5DpBSQFpMcHIpSltB.NWKvVBmHgWpV7/KuzopEk3jPWyS.ABq'
    WHERE "Id" = '11111111-1111-1111-1111-111111111111';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125392Z'
    WHERE "Id" = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125398Z'
    WHERE "Id" = 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Categories" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125399Z'
    WHERE "Id" = 'cccccccc-cccc-cccc-cccc-cccccccccccc';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125531Z'
    WHERE "Id" = '11111111-1111-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125534Z'
    WHERE "Id" = '11111111-2222-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125532Z'
    WHERE "Id" = '22222222-1111-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "OrderItems" SET "CreatedAt" = TIMESTAMPTZ '2026-02-27 10:42:17.125533Z'
    WHERE "Id" = '33333333-1111-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Orders" SET "CustomerName" = NULL, "CustomerPhone" = NULL, "DeliveryAddress" = NULL, "DeliveryFee" = 0.0, "OrderType" = 0, "RestaurantId" = NULL
    WHERE "Id" = '11111111-5555-5555-5555-555555555555';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Products" SET "IsDeleted" = FALSE
    WHERE "Id" = '11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "RestaurantAdmins" SET "PasswordHash" = '$2a$11$H3C4ntyH8u26k6ogm7FQLOuI0NhXS0gA3kvuEj5hutC5/Oz8UsB.6'
    WHERE "Id" = '66666666-6666-6666-6666-666666666666';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    UPDATE "Restaurants" SET "DeliveryEnabled" = FALSE, "DeliveryFee" = 0.0, "TakeawayEnabled" = FALSE
    WHERE "Id" = '22222222-2222-2222-2222-222222222222';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    ALTER TABLE "Orders" ADD CONSTRAINT "FK_Orders_Restaurants_RestaurantId" FOREIGN KEY ("RestaurantId") REFERENCES "Restaurants" ("Id") ON DELETE RESTRICT;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260227104218_AddOrderTypes') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260227104218_AddOrderTypes', '7.0.20');
    END IF;
END $EF$;
COMMIT;
